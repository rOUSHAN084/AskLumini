...
const Api_Url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAR9LPJfmmAcZAQQgLmq8C8Ze1PGOyCC5s";
...
${user.file.data ? `<img src="data:${user.file.mime_type};base64,${user.file.data}" class="chooseimg" />` : ""}
  ...
  <img src="asset/loading.webp" alt="" class="load" width="60px">
      ...
      // Scroll to the bottom *after* adding the AI message and loading indicator
      setTimeout(() => {
          chatContainer.scrollTo({ top: chatContainer.scrollHeight, behavior: "smooth" });
      }, 10); // Slight delay (10ms)
...
imageinput.addEventListener("change", () => {
  ...
  reader.onload = (e) => {
      ...
      image.classList.add("choose"); // Add the choose class to the image
  };
